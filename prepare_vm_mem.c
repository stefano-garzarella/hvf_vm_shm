...
const char s_ckVMCode[] = {
    0x40, 0x00, 0x80, 0xD2, // mov x0, #2       -> x0 = 0x2
    0x00, 0x08, 0x00, 0x91, // add x0, x0, #2   -> x0 = 0x4
    0x02, 0x00, 0x00, 0xD4, // hvc #0
    0x00, 0x08, 0x00, 0xD1, // sub x0, x0, #2   -> x0 = 0x2
    0x03, 0x00, 0x00, 0xD4, // smc #0
    0x00, 0x04, 0x00, 0xD1, // sub x0, x0, #1   -> x0 = 0x1
    0x02, 0x00, 0x00, 0xD4, // hvc #0
    0x00, 0x08, 0x00, 0xD1, // sub x0, x0, #2   -> x0 = 0xffffffffffffffff
